...
begin
	...
	begin
		...
		w_left <= '1'; w_right <= '1'; wait for k_clk_period;
          ...
          assert w_lights_R = "111" report "should have hazards on" severity failure;
        w_left <= '1'; w_right <= '0'; wait for k_clk_period;
          assert w_lights_R = "000" report "should have no right lights on" severity failure;
          wait for k_clk_period;
          assert w_lights_L = "001" report "should have one left light on" severity failure;
          wait for k_clk_period;
